...
export const Disabled = {
  render: () => (
    <div className="flex flex-wrap gap-3 items-center">
      ...
      <Button variant="outline" size="base" disabled>
        Base
      </Button>
...
export const Loading = {
  render: () => (
    <div className="flex flex-wrap gap-3 items-center">
      ...
      <Button variant="outline" size="base" isLoading>
        Base
      </Button>
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <Button variant="outline" size="base" useIcon={<Plus />} isLoading>
          Base
        </Button>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <Button variant="outline" size="base" useIcon={<Plus />} iconPosition="right" isLoading>
          Base
        </Button>
...
export const IconOnly = {
  ...
  render: () => (
    <div className="flex flex-wrap gap-3 items-center">
      ...
      <Button variant="outline" size="icon-base" useIcon aria-label="Add" />
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <Button variant="outline" size="base" useIcon={<Plus />}>
          Base
        </Button>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <Button variant="outline" size="base" useIcon={<Plus />} iconPosition="right">
          Base
        </Button>
