  ...
  render: () => (
    <div className="flex flex-col items-center gap-6 w-full">
      ...
      <p className="text-sm text-gray-500 leading-relaxed max-w-2xl text-center">
        ...
        <code className="font-mono bg-gray-100 px-1 rounded text-xs">shell</code> inner cards hold
        the actual content (stats, tables, forms). This lets the page stay visually flat while still
        grouping related content under a shared header.
      </p>

      {/* 2. Live preview */}
      <div className="p-6 max-w-5xl space-y-6 w-full">
        <PageHeader
