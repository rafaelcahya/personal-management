...
const meta = {
  title: 'Input/DatePicker/DatePicker/Disabled',
}
        ...
        items={[
          {
            ...
            cards: [
              {
                title: 'Disable the picker when the value is locked for the current context',
                body: 'A trade date set by a system rule, locked after submission, or read-only in a review screen should be disabled — the date stays visible but cannot be changed.',
              },
              {
                title: 'Use FieldContent disabled for full field suppression',
                body: 'Wrapping in FieldContent with disabled automatically disables the picker and dims the label — no need to pass disabled separately to DatePicker.',
              },
            ],
          },
          {
            ...
            cards: [
              {
                ...
                body: 'A muted trigger with no explanation causes confusion. Use FieldDescription to say "Locked after submission" or "Set by your administrator" so users understand.',
              },
            ],
          },
        ]}
