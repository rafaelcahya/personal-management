...
const meta = {
  title: 'Input/DatePicker/MonthPicker/Error State',
}
...
function FieldDemo() {
  ...
  return (
    <FieldContent size="base" error="Month is required.">
    ...
    <div className="flex flex-col items-center gap-6 w-full">
      ...
      <div className="flex flex-col gap-4 w-80">
        <div className="flex flex-col gap-1">
          ...
          <MonthPicker variant="error" placeholder="Pick a month" />
        </div>
...
<MonthPicker variant="error" value={month} onChange={setMonth} />
