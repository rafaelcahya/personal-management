...
Cypress.Commands.add('GetListEvent', (qs = {}) => {
  return cy.apiRequestWithSession('GET', `/api/trade/v1/event/list`, { qs })
})

Cypress.Commands.add('GetListEventNoAuth', (qs = {}) => {
  return cy.apiRequestNoAuth('GET', `/api/trade/v1/event/list`, { qs })
})

Cypress.Commands.add('GetEventTags', () => {
  return cy.apiRequestWithSession('GET', `/api/trade/v1/event/tags`)
})

Cypress.Commands.add('GetEventTagsNoAuth', () => {
  return cy.apiRequestNoAuth('GET', `/api/trade/v1/event/tags`)
})
