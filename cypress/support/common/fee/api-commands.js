...
Cypress.Commands.add("GetListFee", () => {
    return cy.apiRequestWithSession("GET", `/api/trade/v1/fee/list`);
});

Cypress.Commands.add("GetListFeeNoAuth", () => {
    return cy.apiRequestNoAuth("GET", `/api/trade/v1/fee/list`);
});
