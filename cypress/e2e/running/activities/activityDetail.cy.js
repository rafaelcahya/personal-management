...
// Covers: Activity Detail page UI — /main/running/activities/:id
//
// Test suites:
//   A. Auth guard — unauthenticated redirects to /login
//   B. Page root renders #activityDetailPage
//   C. Stats + derived metrics (EF, VO2max, aeroDrift, derivedMetricsGuide)
//   D. Notes — inline edit happy path
//   E. Notes — cancel discards changes
//   F. Notes — API error shows toast
//   G. Edit Goal modal — open and close
//   H. Edit Goal modal — save updates displayed goal
//   I. Linked race badge renders when race-log entry matches activity
//   J. No linked race badge when race-log has no matching entry
//   K. Pre-activity context — no health log shows prompt
//   L. Pre-activity context — health log renders sleep/energy/mood fields
//   M. Splits table renders when splits are present + cardiac drift
//   N. Best efforts table renders
//   O. Laps table renders
//   P. API error state — activity fetch 500 shows error message
...
// ---------------------------------------------------------------------------
// C. Derived metrics — EF, VO2max, aeroDrift, derivedMetricsGuide
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// J. Linked race badge — hidden when no matching entry
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// L. Pre-activity context — health log renders fields
// ---------------------------------------------------------------------------
