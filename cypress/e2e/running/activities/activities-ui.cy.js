// Generated by Cypress Author — 2026-05-27
// Covers: Activities list page UI — /main/running/activities
//
// AUTH STRATEGY:
//   The activities page is inside (app)/layout.jsx which validates a real Supabase session.
//   We use cy.setupApiAuthCookies() for a real session and stub the rt_users table check so
//   we don't need an onboarding_complete DB record.
//   The fetchActivities API call is stubbed in all rendering tests for determinism and speed.
//
// TEST IDs (from app-constants.json):
//   activitiesPage, activitiesLoadingSkeleton, activitiesError, activitiesList
//
// ELEMENT STRATEGY:
//   The page uses id="..." (not data-testid) on key containers. We target them with #idName.
//   Pagination buttons are identified by aria-label ("Previous page", "Next page").

import constants from '../../../fixtures/app-constants.json'

const ROUTE = constants.routes.running_activities
const IDS = constants.test_ids.running_activities
const ACTIVITIES_ENDPOINT = constants.endpoints.running_manual.activities
...
/** Minimal activity fixture factory. */
...
/** Stub GET /api/running/v1/activities with a list response. */
...
/** Stub GET /api/running/v1/activities with a 500 error. */
...
// ---------------------------------------------------------------------------
// C. Happy path — activity cards render
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// D. Type filter changes query param in URL
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// E. Pagination next / prev buttons
// ---------------------------------------------------------------------------
