...
// Fixed: 2026-05-16 — use setupApiAuthCookies() in before() hooks;
// search by brand name before asserting rows to ensure visibility;
// stub bulk action API calls so they succeed in UI context.
...
describe('Product Brand List - UI Tests', () => {
  ...
  // Generated by Cypress Author — 2026-05-16
  // Covers: Bulk Set Active — create inactive brands, check, click Set Active, verify status
  ...
  // Generated by Cypress Author — 2026-05-16
  // Covers: Filter & Sort badge dot counter — increments for each active filter/non-default sort
  ...
  // Generated by Cypress Author — 2026-05-16 [P2]
  // Covers: Product count badge — blue badge navigates to product list; gray badge does not navigate
  ...
  // Generated by Cypress Author — 2026-05-16 [P2]
  // Covers: Sort by product count — "Most products first" and "Fewest products first"
