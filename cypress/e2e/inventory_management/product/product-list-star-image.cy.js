// Covers: v1.2 inventory frontend fixes for ProductsTable
//   - #33: Non-favorite star shows grey (text-slate-300), not invisible
//   - #34: Product image thumbnail click opens image preview dialog
...
const RESTOCK_API =
  INVENTORY_ENDPOINTS.RESTOCK_PREDICTIONS || '/api/inventory/v1/product/restock-predictions'

const IDS = constants.test_ids.product_list
...
// ---------------------------------------------------------------------------
// A. #33 — Non-favorite star shows grey (text-slate-300)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// B. #34 — Image thumbnail click opens preview dialog
// ---------------------------------------------------------------------------
