            ...
            <table className="w-full text-sm">
                <thead>
                    <tr className="border-b border-slate-200">
                        ...
                        <th className="text-right py-3 px-3 text-xs font-semibold text-slate-500 uppercase tracking-wide">Avg Duration</th>
                    </tr>
                </thead>
                <tbody>
                    {data.map((item, index) => (
                        <tr key={item.product_list_id} className="border-b border-slate-100 hover:bg-violet-50/30 transition-colors">
