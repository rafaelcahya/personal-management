                ...
                <div key={month}>
                    ...
                    {grouped[month].map((item, idx) => (
                        ...
                        >
                            ...
                            <span className="font-semibold text-violet-700 text-sm">{formatRupiah(item.total_spent)}</span>
                        </div>
                    ))}
                </div>
            ))}
        ...
        <>
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm shadow-slate-100 overflow-hidden">
                <div className="px-5 py-4 border-b border-slate-100">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Spending per product category (last 6 months)</p>
                </div>
