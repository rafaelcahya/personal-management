            ...
            <form onSubmit={handleSubmit(handleUpdateSettings)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field, fieldState }) => (
                  <FormItem>
                    <FormLabel className="font-medium">Initial Margin</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type="text"
              ...
              <FormField
                ...
                render={({ field, fieldState }) => (
                  <FormItem>
                    <FormLabel className="font-medium">Personal Risk Free Rate</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type="text"
              ...
              <FormField
                ...
                render={({ field, fieldState }) => (
                  <FormItem>
                    <FormLabel className="font-medium">Margin of Error</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type="text"
