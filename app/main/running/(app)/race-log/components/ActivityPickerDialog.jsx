    ...
    <Modal open={open} onOpenChange={(v) => !v && onClose()}>
      ...
      >
        ...
        <ModalBody className="flex-1 min-h-0 flex flex-col p-0 gap-0">
          ...
          {/* Table */}
          <Table
            wrapperClassName="flex-1 overflow-auto min-h-0"
            className="min-w-[480px] table-auto"
          >
            <TableHeader sticky className="bg-slate-50">
              <TableRow className="border-none uppercase text-xs">
                ...
                <TableHead align="right" className="py-2 text-slate-500">
                  Dist
                </TableHead>
                <TableHead align="right" className="py-2 text-slate-500">
                  Pace
                </TableHead>
                <TableHead align="right" className="py-2 pr-5 text-slate-500">
                  Time
                </TableHead>
              </TableRow>
            </TableHeader>
                ...
                activities.map((a) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        align="right"
                        className="font-mono tabular-nums text-sm text-slate-700"
                      >
                      ...
                      <TableCell
                        align="right"
                        className="pr-5 font-mono tabular-nums text-sm text-slate-700"
                      >
