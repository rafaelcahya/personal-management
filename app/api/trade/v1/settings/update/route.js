...
export async function PUT(request) {
  try {
    ...
    const { initial_margin, bi_risk_free_rate, personal_risk_free_rate, margin_of_error } = body
    ...
    if (settingsData.bi_risk_free_rate < 0 || settingsData.bi_risk_free_rate > 100) {
      return NextResponse.json(
        {
          success: false,
    ...
    if (settingsData.personal_risk_free_rate < 0 || settingsData.personal_risk_free_rate > 100) {
      return NextResponse.json(
        {
          success: false,
    ...
    if (settingsData.margin_of_error < 0 || settingsData.margin_of_error > 100) {
      return NextResponse.json(
        {
          success: false,
