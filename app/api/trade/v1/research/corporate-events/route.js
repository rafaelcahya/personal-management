...
async function computeCorporateEvents(ticker) {
  ...
  return { ticker, earnings, insiderTransactions, upcomingDividend }
}
...
export async function GET(request) {
  try {
    ...
    const data = await getCachedResearch(ticker, 'corporate-events', () =>
      computeCorporateEvents(ticker)
    )
