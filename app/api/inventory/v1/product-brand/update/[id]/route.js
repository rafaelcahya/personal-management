...
import { updateProductBrand } from '@/lib/services/inventory/product_brand/updateProductBrand'
...
export async function PUT(req, { params }) {
  try {
    ...
    const updatedProductBrand = await updateProductBrand(Number(id), body, user.id)
