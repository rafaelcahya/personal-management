...
import { createProductBrand } from '@/lib/services/inventory/product_brand/createProductBrand'
...
export async function POST(req) {
  try {
    ...
    return NextResponse.json({ success: true, productBrand: newProductBrand }, { status: 201 })
  } catch (err) {
    console.error('POST /api/inventory/v1/product-brand/create error:', err)
