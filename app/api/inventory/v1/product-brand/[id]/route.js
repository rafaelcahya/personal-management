...
import { getSingleProductBrand } from '@/lib/services/inventory/product_brand/getSingleProductBrand'
...
export async function GET(req, { params }) {
  try {
    ...
    return NextResponse.json({ success: true, data: productBrand }, { status: 200 })
  } catch (err) {
