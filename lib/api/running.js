...
export async function fetchZoneAnalytics(range = '3m', activityType = 'All', startDate, endDate) {
  const params = new URLSearchParams({ range, activity_type: activityType })
...
export async function fetchGearAnalytics(range = '3m', activityType = 'All', startDate, endDate) {
  const params = new URLSearchParams({ range, activity_type: activityType })
  if (startDate) params.set('start_date', startDate)
  if (endDate) params.set('end_date', endDate)
