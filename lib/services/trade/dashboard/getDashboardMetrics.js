...
export async function getDashboardMetrics() {
    ...
    try {
        ...
        // Fetch trades and settings in parallel
        ...
        // Get initial margin from settings
...
function calculateMetrics(trades, initialMargin, settings) {
    ...
    // Portfolio metrics - use initialMargin from settings
    ...
    // Sharpe ratios - use settings values
    ...
    // Safe zones - use margin of error from settings
