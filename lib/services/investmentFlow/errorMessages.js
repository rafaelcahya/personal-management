...
export const USER_FACING_ERRORS = {
  ...
  INSUFFICIENT_CASH: 'Insufficient balance in the selected cash pool.',
  NODE_NOT_CLOSABLE: 'Only a ticker position with a nominal and no child nodes can be closed.',
  CASH_CATEGORY_NOT_FOUND: 'The selected cash pool was not found.',
}
